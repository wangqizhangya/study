        ...
        fortune.spin = function(price, sub_price) {
            ...
            fortune
              .css({
                ...
                "transition": "transform " + duration + "ms cubic-bezier(0.38, 0.14, 0.2, 0.82)",
                "-webkit-transition": "-webkit-transform " + duration + "ms cubic-bezier(0.38, 0.14, 0.2, 0.82)"
              })
